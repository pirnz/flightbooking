		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#FlightBookingsworkshop-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"FlightBookingsworkshop-display": {
								"semanticObject": "FlightBookingsworkshop",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=FlightBookings.workshop.",
									"url": sap.ui.require.toUrl("FlightBookings/workshop/")
								}
							}
						}
					}
